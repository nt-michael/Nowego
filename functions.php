...
function custom_bulk_admin_notices() {
	...
	if ( $couponxl_cpt !== '1.1' ) {
		echo '<div id="message" class="error notice">
	        <p>' . esc_html__( 'Reinstall Coupon XL Custom Post Types plugin ( delete it and theme will offer you to install it again )', 'couponxl' ) . '.</p>
	    </div>';
	}

	if ( $smeta !== '1.2' ) {
		echo '<div id="message" class="error notice">
	        <p>' . esc_html__( 'Reinstall Smeta plugin ( delete it and theme will offer you to install it again )', 'couponxl' ) . '.</p>
	    </div>';
	}
}
